...
def phoneGW():
    User_phone = input(
        f"\n {Wh}Enter phone number target {Re}Ex [+91xxxxxxxxx] {Wh}: {Re}")  # INPUT NUMBER PHONE
...
| ___ \       | |     \ \ / /_   _|            | |   
| |_/ /___  __| |______\ V /  | |_ __ __ _  ___| | __
|    // _ \/ _` |______/   \  | | '__/ _` |/ __| |/ /
| |\ \  __/ (_| |     / /^\ \ | | | | (_| | (__|   < 
\_| \_\___|\__,_|     \/   \/ \_/_|  \__,_|\___|_|\_\
                                                             

         {Re}[ + ]  C O D E   B Y  R E D - X  [ + ]
    """)
...
def run_banner():
    ...
    stderr.writelines(f"""{Wh}
         .-.
       .'   `.          {Wh}--------------------------------
       :g g   :         {Wh}| {Re}RED-X TRACKER - IP ADDRESS {Wh}|
       : o    `.        {Wh}|       {Re}CODE BY @REDX_64      {Wh}|
      :         ``.     {Wh}--------------------------------
     :             `.
    :  :         .   `.
    :   :          ` . `.
